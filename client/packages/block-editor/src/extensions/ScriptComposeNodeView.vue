...
.vance-compose__run {
  ...
  border: 1px solid var(--color-primary); background: var(--color-primary); color: var(--color-primary-content);
  border-radius: 0.35rem; font-size: 0.9rem; line-height: 1; cursor: pointer;
}
.vance-compose__run--stop { border-color: var(--color-error); background: var(--color-error); color: var(--color-error-content); }
.vance-compose__run:disabled { opacity: 0.55; cursor: default; }
.vance-compose__menu-wrap { position: relative; }
.vance-compose__menu-btn {
  display: inline-flex; align-items: center; justify-content: center;
  width: 2rem; height: 2rem;
  border: 1px solid color-mix(in oklab, var(--color-base-content) 25%, transparent); background: transparent; color: inherit;
...
.vance-compose__menu {
  ...
  border: 1px solid color-mix(in oklab, var(--color-base-content) 20%, transparent); border-radius: 0.4rem; background: var(--color-base-100);
...
.vance-compose__menu-item:hover { background: color-mix(in oklab, var(--color-base-content) 10%, transparent); }
...
.vance-compose__error { color: var(--color-error); font-size: 0.82rem; }
</style>
