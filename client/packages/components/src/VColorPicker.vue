...
function colorName(c: AccentColor): string {
...
const emit = defineEmits<{
  (e: 'update:modelValue', value: AccentColor | null): void;
}>();
...
const SWATCHES: ReadonlyArray<{ value: AccentColor; bg: string; ring: string }> = [
  { value: AccentColor.SLATE, bg: 'bg-slate-500', ring: 'ring-slate-500' },
  { value: AccentColor.RED, bg: 'bg-red-500', ring: 'ring-red-500' },
  { value: AccentColor.ORANGE, bg: 'bg-orange-500', ring: 'ring-orange-500' },
  { value: AccentColor.AMBER, bg: 'bg-amber-500', ring: 'ring-amber-500' },
  { value: AccentColor.GREEN, bg: 'bg-green-500', ring: 'ring-green-500' },
  { value: AccentColor.TEAL, bg: 'bg-teal-500', ring: 'ring-teal-500' },
  { value: AccentColor.CYAN, bg: 'bg-cyan-500', ring: 'ring-cyan-500' },
  { value: AccentColor.BLUE, bg: 'bg-blue-500', ring: 'ring-blue-500' },
  { value: AccentColor.INDIGO, bg: 'bg-indigo-500', ring: 'ring-indigo-500' },
  { value: AccentColor.PURPLE, bg: 'bg-purple-500', ring: 'ring-purple-500' },
  { value: AccentColor.PINK, bg: 'bg-pink-500', ring: 'ring-pink-500' },
  { value: AccentColor.ROSE, bg: 'bg-rose-500', ring: 'ring-rose-500' },
];

const current = computed<AccentColor | null>(() => props.modelValue ?? null);

function pick(value: AccentColor | null): void {
