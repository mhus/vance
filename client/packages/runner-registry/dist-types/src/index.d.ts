 ...
 */
export declare function registerRunner(adapter: RunAdapter): void;
/**
 * Resolve a Run adapter by its stable id.
 */
export declare function resolveRunner(id: string): RunAdapter | undefined;
/**
 ...
 */
export declare function resolveRunAdapter(doc: RunnerDocument): RunAdapter | undefined;
/**
 * Snapshot of all currently-registered runners in insertion order.
 */
export declare function listRunners(): RunAdapter[];
