...
function languageFor(mimeType) {
    ...
    if (mt === 'application/xml' || mt === 'text/xml')
        return xml();
    // SQL.
    if (mt === 'application/sql' || mt === 'text/x-sql' || mt === 'text/sql')
        return sql();
    // Java.
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div)({
    ref: "host",
    ...{ class: "code-editor" },
    ...{ style: ({ minHeight: `${__VLS_ctx.rows * 1.5}rem` }) },
    ...{ class: ({ 'code-editor--disabled': __VLS_ctx.disabled }) },
});
...
/** @type {__VLS_StyleScopedClasses['code-editor']} */ ;
/** @type {__VLS_StyleScopedClasses['code-editor--disabled']} */ ;
var __VLS_dollars;
