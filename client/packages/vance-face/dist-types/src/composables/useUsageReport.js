...
export function useUsageReport() {
    ...
    const byProject = ref(null);
    const byModel = ref(null);
    ...
    async function loadAll(params) {
        ...
        try {
            const [s, p, m] = await Promise.all([
                brainFetch('GET', `usage/summary?${buildQuery({
                    from: params.from,
                    to: params.to,
                    groupBy: params.groupBy,
                    projectId: params.projectId,
                })}`),
                brainFetch('GET', `usage/by-project?${buildQuery({
                    from: params.from,
                    to: params.to,
                })}`),
                brainFetch('GET', `usage/by-model?${buildQuery({
                    from: params.from,
                    to: params.to,
                })}`),
            ]);
...
//# sourceMappingURL=useUsageReport.js.map