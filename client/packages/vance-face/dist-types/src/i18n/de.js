...
export default {
    ...
    index: {
        ...
        chat: {
            title: 'Chat',
            description: 'Live-Chat mit dem Brain über WebSocket. Bestehende Session auswählen oder eine neue in einem beliebigen Projekt starten.',
        },
        documents: {
            title: 'Dokumente',
        ...
        scopes: {
            title: 'Bereiche',
            description: 'Mandant, Projektgruppen und Projekte verwalten. Einstellungen auf Mandanten- oder Projektebene bearbeiten.',
        },
        tools: {
            title: 'Server-Tools',
            description: 'Server-seitige Tools pro Projekt konfigurieren. Projekt oder _vance für mandantenweite Vorgaben wählen.',
        },
        insights: {
            title: 'Insights',
            description: 'Sessions, Think-Processes, Chat-Verlauf, Memory und Marvin-Bäume inspizieren. Nur-Lesen-Diagnoseansicht.',
        },
        users: {
            title: 'Benutzer & Teams',
            description: 'Mandanten-Benutzer verwalten (anlegen, Passwort-Reset, Status) und Teams (Mitglieder, Aktiv-Flag).',
        },
        open: 'Öffnen',
    },
    chat: {
        ...
        export: {
            saveAsDocumentTooltip: 'Diese Konversation als Markdown-Dokument im Projekt des Chats speichern (Summary und RAG-Indexierung standardmäßig aus).',
        ...
        sessionHeader: {
            ...
            reactivateConfirm: 'Diese archivierte Session wieder aktiv schalten? Eine neue Engine startet auf Basis der bestehenden Konversation.',
            delete: 'Löschen',
            deleteConfirm: 'Diese Session unwiderruflich löschen? Alle Nachrichten und Metadaten gehen verloren.',
            archived: 'Archiviert',
    ...
    documents: {
        ...
        noProjectsBody: 'Bitten Sie einen Administrator, ein Projekt anzulegen, bevor Dokumente eingesehen werden können.',
        pickAProjectHeadline: 'Projekt wählen',
        pickAProjectBody: 'Wählen Sie oben ein Projekt aus, um dessen Dokumente zu laden.',
        backToList: 'Zurück zur Liste',
        pathFilterPlaceholder: 'Nach Ordner oder Pfad-Präfix filtern… (z. B. notes/, archive/2026)',
        allKinds: 'Alle Arten',
        ...
        detail: {
            ...
            titleLabel: 'Titel',
            pathLabel: 'Pfad',
            pathHelp: 'Dieses Dokument verschieben oder umbenennen. Der Pfad ist projektweit eindeutig; Konflikte werden abgelehnt.',
            mimeTypeLabel: 'MIME-Type',
            mimeTypeHelp: 'Inhaltstyp dieses Dokuments. Wenn der ursprüngliche Type falsch geraten war (z.B. Markdown als text/plain importiert), hier korrigieren.',
            summaryEditorLabel: 'Zusammenfassung',
            summaryEditorHelp: 'Kurze Beschriftung / Beschreibung. Slideshows zeigen das unter jedem Bild; der Auto-Summary-Scheduler schreibt hier für Text-Dokumente. Bei Binärdaten (Bilder, PDFs) schreibt das LLM oder der Nutzer manuell.',
            ...
            summary: {
                ...
                autoSummaryHelp: 'Default ist „an" für text/markdown und text/plain. Ausschalten, um den Scheduler von diesem Dokument fernzuhalten.',
                summaryDirtyLabel: 'Als dirty markieren — beim nächsten Tick neu zusammenfassen',
                summaryDirtyHelp: 'Server räumt das Flag nach erfolgreichem Lauf wieder ab. Manuell setzen erzwingt einen Refresh ohne Body-Edit.',
            },
        },
        calendar: {
            viewMonth: 'Monat',
        ...
        archives: {
            ...
            confirmRestoreBody: 'Der aktuelle Inhalt wird als neue Version archiviert, danach wird diese ältere Version zum aktiven Dokument. Es geht nichts verloren.',
            confirmDeleteTitle: 'Diese Version dauerhaft löschen?',
            confirmDeleteBody: 'Diese archivierte Version wird endgültig entfernt. Das aktive Dokument ist nicht betroffen.',
        },
        listEditor: {
        ...
        create: {
            ...
            filesLabel: 'Dateien',
            filesHelp: 'Eine oder mehrere Dateien ablegen. Der Server entscheidet pro Datei automatisch über Komprimierung.',
        ...
        delete: {
            ...
            body: '{path} in den Papierkorb verschieben? Du kannst es später unter {bin} endgültig löschen.',
            cancel: 'Abbrechen',
            confirm: 'In Papierkorb',
            titlePermanent: 'Endgültig löschen',
            bodyPermanent: '{path} endgültig löschen? Das Dokument und sein Inhalt werden entfernt. Diese Aktion kann nicht rückgängig gemacht werden.',
            confirmPermanent: 'Endgültig löschen',
        },
        discard: {
            title: 'Ungespeicherte Änderungen',
            body: 'An diesem Dokument gibt es Änderungen, die noch nicht gespeichert wurden. Was möchtest du tun?',
    ...
    insights: {
        ...
        emptyMain: {
            ...
            body: 'Links eine Session auswählen, um sie zu inspizieren — oder aufklappen, um in ihre Prozesse zu drillen.',
        },
        breadcrumbs: {
        ...
        process: {
            ...
            memoryEmptyBody: 'Keine Engine-Memory-Einträge sind diesem Prozess zugeordnet.',
            ...
            prakRunsEmptyBody: 'Für diesen Prozess existieren noch keine PrakRunRecord-Zeilen. Aktiviere vance.prak.sideChannelEnabled und löse eine Compaction aus.',
        ...
        workflows: {
            ...
            emptyBody: 'Dieses Projekt hat keine Workflow-YAMLs unter _vance/workflows/. Lege einen mit dem workflow-author-Skill an und lade neu.',
            selectHeadline: 'Workflow auswählen',
            selectBody: 'Wähle links einen Workflow, um Definition und Runs zu sehen.',
            ...
            trigger: {
                title: 'Auslösen',
                help: 'Startet einen neuen Workflow-Run. Fülle die Parameter aus (Pflichtfelder mit *), dann auslösen. Der Run läuft asynchron auf der Projekt-Lane.',
        ...
        events: {
            ...
            emptyBody: 'Dieses Projekt hat keine Event-YAMLs unter _vance/events/. Lege eines mit dem event-author-Skill an und lade neu.',
            selectHeadline: 'Event auswählen',
            selectBody: 'Wähle links ein Event, um Details zu sehen und es auszulösen.',
            disabledHint: 'Event ist deaktiviert — setze enabled: true in der YAML, um es auszulösen.',
        ...
        llmTrace: {
            ...
            emptyBody: 'Entweder war tracing.llm beim Lauf des Prozesses aus, oder alle Einträge sind durch die TTL (90 Tage) entfernt worden.',
            orphan: '(verwaist)',
        ...
        cacheStats: {
            ...
            emptyBody: 'Entweder war tracing.llm beim Lauf aus, oder der Provider liefert keine Cache-Tokens (Gemini, OpenAI). Cache-Tracking ist heute Anthropic-spezifisch.',
            headlineTitle: 'Cache-Hit-Rate',
            headlineSub: 'über {rounds} LLM-Calls',
            headlineHint: 'Anteil der Eingabe-Tokens, die aus dem Anthropic-Prompt-Cache gelesen wurden — höher ist besser. Spec-Ziel: ≥ 70 %.',
            ...
            savingsHint: 'Aus-Cache-Tokens kosten ~10 % des normalen Eingabe-Preises; die Spar-Schätzung ignoriert die einmaligen Schreib-Aufschläge auf Creation-Tokens.',
            reload: 'Neu laden',
        },
        timeline: {
            loading: 'Timeline wird geladen…',
            noProcessesHeadline: 'Noch keine Prozesse',
            noProcessesBody: 'Diese Session hat keine Think-Processes — nichts zum Anzeigen.',
    ...
    tools: {
        ...
        detail: {
            ...
            delete: 'Löschen',
            save: 'Speichern',
            tenantNote: 'Sie bearbeiten das System-Projekt _tenant — Änderungen hier sind mandantenweite Vorgaben. Benutzerprojekte überschreiben einzelne Tools, indem sie sie mit dem gleichen Namen neu anlegen.',
            cascadedFromTenant: 'Dieses Tool kommt aus _tenant (Mandanten-Default). Speichern legt einen project-spezifischen Override an — der ersetzt die Mandanten-Vorgabe nur in diesem Projekt.',
            cascadedFromBundled: 'Dieses Tool ist ein eingebauter Default (vance-defaults). Speichern legt einen project-spezifischen Override an, der den Default in diesem Projekt ersetzt.',
        },
        source: {
            project: 'Projekt',
            tenant: 'Tenant',
        ...
        cards: {
            ...
            parametersHelp: 'Typ-spezifische Konfiguration. Das Parameter-Schema der Factory wird im Hilfe-Panel angezeigt.',
            labelsTitle: 'Labels',
            packTitle: 'Pack',
            packHelp: 'Multi-Tool-Packs (REST-API, MCP-Server) expandieren in viele Sub-Tools. Die folgenden Felder konfigurieren Pack-weite Defaults; Singleton-Packs (z. B. doc_lookup) ignorieren sie.',
        },
        fields: {
            type: 'Typ',
            description: 'Beschreibung',
            descriptionHelp: 'Wird dem LLM angezeigt. Ein kurzer Absatz, Klartext.',
            enabled: 'Aktiviert',
            primary: 'Primär (in jeder Runde angekündigt)',
            defaultDeferred: 'Standardmäßig deferred',
            defaultDeferredHelp: 'Pack-weiter Default für Tool.deferred(). Bei true erscheinen Sub-Tools nur im Discovery-Block, bis das LLM sie über describe_tool aktiviert — empfohlen für Packs mit vielen Endpunkten.',
            disabledSubTools: 'Deaktivierte Sub-Tools',
            disabledSubToolsHelp: 'Ein Sub-Tool-Name pro Zeile. Nur lokale Namen (ohne <pack>__-Präfix). Leer bedeutet: alle Sub-Tools aktiv.',
            labels: 'Labels',
            labelsHelp: 'Eines pro Zeile (oder Komma-getrennt). Recipes können Labels über @<label> ansprechen.',
        },
        rightPanel: {
            typeSchemaTitle: 'Typ-Schema',
            pickTypeHint: 'Einen Typ auswählen, um sein Parameter-Schema zu sehen.',
            cascadeTitle: 'Cascade',
            cascadeBody: 'Zur Laufzeit werden Tools über project → _vance → eingebaute Beans aufgelöst. Deaktivierte Dokumente stoppen die Cascade — so versteckt man ein System-Tool innerhalb eines einzelnen Projekts.',
        },
        errors: {
            ...
            nameRequired: 'Name ist erforderlich.',
            namePattern: 'Name muss aus Kleinbuchstaben/Ziffern bestehen, optional mit „_" (snake_case).',
            nameAlreadyExists: 'Ein Tool mit Namen „{name}" existiert bereits in diesem Projekt.',
        ...
        confirmDelete: 'Server-Tool „{name}" löschen? Eingebaute Bean-Tools gleichen Namens werden durch die Cascade-Fallback wieder sichtbar.',
        stubDescription: '{name} — TODO Beschreibung',
        newModal: {
            title: 'Neues Server-Tool',
            nameLabel: 'Name',
            nameHelp: 'Kleinbuchstaben/Ziffern + „_". Snake_case, wie die mitgelieferten Tools (z. B. doc_getting_started).',
    ...
    users: {
        ...
        user: {
            ...
            confirmDelete: 'Benutzer „{name}" löschen? Mitgliedschaften in Teams werden nicht automatisch entfernt.',
            statusOptions: {
                active: 'ACTIVE',
                disabled: 'DISABLED',
                pending: 'PENDING',
            ...
            settings: {
                ...
                intro: 'Benutzer-Einstellungen liegen im synthetischen Projekt _user_{name}. Sie haben in der Cascade Vorrang vor Projekt- und Mandanten-Einstellungen — nützlich für Benutzer-Modellpräferenzen, API-Keys, Sprachvorgaben.',
                noSettingsHeadline: 'Keine Einstellungen',
                noSettingsBody: 'Unten ein Schlüssel/Wert-Paar hinzufügen, um Mandanten-Vorgaben für diesen Benutzer zu überschreiben.',
                valueLabel: 'Wert',
        ...
        team: {
            ...
            membersPlaceholder: 'Ein Benutzername pro Zeile. Eine Zeile entfernen entfernt das Mitglied.',
        ...
        createUser: {
            ...
            passwordHelp: 'Leer lassen erzeugt ein passwortloses Konto, das sich nicht anmelden kann, bis ein Passwort gesetzt wird.',
            cancel: 'Abbrechen',
            create: 'Anlegen',
            nameInvalid: 'Name muss aus Kleinbuchstaben/Ziffern bestehen, optional mit „.", „-" oder „_".',
        ...
        setPassword: {
            ...
            intro: 'Ersetzt das Passwort von {name}. Klartext wird serverseitig gehasht.',
            newPasswordLabel: 'Neues Passwort',
    ...
    settingForms: {
        ...
        emptyBody: 'Settings-Formulare sind YAML-Dateien unter _vance/setting_forms/, die strukturiert Settings setzen.',
    ...
    scopes: {
        ...
        project: {
            ...
            archivedNote: 'Dieses Projekt ist archiviert. Es ist für Runtime-Claims schreibgeschützt, aber Metadaten können noch geändert werden.',
            ...
            languagesDescription: 'Per-Projekt-Sprachen. Sind sie nicht gesetzt, fällt die Auflösung auf User- bzw. Tenant-Default zurück.',
            languageNotSet: 'Nicht gesetzt',
            chatLanguageLabel: 'Assistenten-Sprache (Chat)',
            chatLanguageHelp: 'Überschreibt die Profil-Einstellung des Nutzers. Beispiel: englisches Code-Review-Projekt eines deutschsprachigen Users.',
            contentLanguageLabel: 'Inhaltssprache (Dokumente, Insights, Memory)',
            contentLanguageHelp: 'Sprache der vom Assistenten geschriebenen Inhalte. Bewusst ohne User-Ebene — Inhalte gehören dem Projekt.',
        },
        kit: {
            cardTitle: 'Kit',
            ...
            dialog: {
                ...
                pruneHelp: 'Auch Dateien / Settings / Tools löschen, die in der vorherigen Kit-Version waren, aber in der neuen nicht mehr enthalten sind.',
                keepPasswords: 'Bestehende Passwörter behalten',
                keepPasswordsHelp: 'Mit dem Kit gelieferte PASSWORD-Settings überspringen, damit bestehende Projekt-Anmeldedaten erhalten bleiben.',
                trackManifest: 'Im Kit-Manifest erfassen',
                trackManifestHelp: 'An (Default): Dateien werden im _vance/kit-manifest.yaml als Kit-Bestandteil verzeichnet, Update/Export bleiben möglich. Aus: einmaliger Splat ohne Tracking — gut für Tunings (Extra-Tools/Settings) ohne Bindung an das aktive Kit.',
        ...
        settingFormsPanel: {
            emptyHeadline: 'Keine Formulare verfügbar',
            emptyBodyProject: 'Formulare sind YAML-Dateien unter _vance/setting_forms/ — z.B. „LLM-Einstellungen", „Quota-Voreinstellung" oder „Jira-Anbindung". Über Kits oder Tenant-Defaults bereitgestellt.',
            emptyBodyTenant: 'Formulare sind typischerweise auf Projekt-Ebene anwendbar. Links ein Projekt auswählen, um die für dieses Projekt verfügbaren Formulare zu sehen.',
            backToList: '← Zurück zur Liste',
        },
        createGroup: {
            title: 'Neue Projektgruppe',
    ...
    inbox: {
        ...
        actions: {
            ...
            reasonPlaceholder: 'Grund (optional, für „nicht ausreichend" / „nicht entscheidbar")',
        ...
        delegate: {
            ...
            body: 'Diesen Eintrag an ein anderes Teammitglied übergeben. Es sieht den Eintrag im eigenen Posteingang und kann ihn beantworten oder archivieren.',
            recipient: 'Empfänger',
            note: 'Notiz (optional)',
            cancel: 'Abbrechen',
            confirm: 'Delegieren',
    ...
    profile: {
        ...
        preferences: {
            title: 'Einstellungen',
            description: 'Werden im Benutzer-Bereich gespeichert. Andere Clients (Foot, Mobile) ignorieren Keys mit dem Präfix webui.',
            language: 'Sprache',
            ...
            chatLanguageDescription: 'In welcher Sprache der Assistent antwortet und zuhört. Wird vom Projekt überschrieben, wenn dort etwas gesetzt ist.',
            ...
            uiLevel: 'Ansicht',
            uiLevelDescription: 'Welche Bereiche auf der Startseite sichtbar sind. Server-Berechtigungen bleiben unabhängig wirksam.',
        ...
        speech: {
            title: 'Sprache & Audio',
            description: 'Voreinstellungen für Vorlesen und Spracherkennung. Welche Stimmen verfügbar sind, hängt vom Browser ab; im Chat gibt es Schnellregler für Lautstärke und Geschwindigkeit.',
            voice: 'Stimme',
        ...
        actions: {
            ...
            refreshModelCatalogDescription: 'Liest alle Modell-Dokumente unter _vance/model/** neu ein und baut den In-Memory-Katalog neu auf. Der Brain refresht zusätzlich automatisch alle 30 Minuten.',
            refreshModelCatalogBusy: 'Wird neu geladen…',
            refreshModelCatalogResult: '{bundled} Bundled-Modelle, {providers} Provider, {scopes} Override-Scopes in {ms} ms neu geladen.',
            discoverModels: 'KI-Modelle entdecken',
            discoverModelsDescription: 'Geht alle Projekte des Mandanten durch, ruft das Listing-Endpoint jedes konfigurierten Providers und schreibt Pro-Modell-Dokumente unter _vance/model-auto/**. Manuelle Edits unter _vance/model/** werden nicht angefasst.',
            discoverModelsBusy: 'Entdecke…',
            discoverModelsResult: '{written} Modell(e) gefunden über {instances} Provider-Instance(s) in {scopes} Projekt(en) ({ms} ms).',
            discoverModelsSkipped: '{count} Instance(s) übersprungen:',
        },
    },
    workspace: {
