...
export default {
    ...
    fook: {
        ...
        intro: 'Describe what happened, what you expected, or what you wish Vance did. '
        ...
        placeholder: 'What went wrong, or what would you want to change? Steps to reproduce help.',
        submit: 'Submit',
    ...
    index: {
        ...
        chat: {
            title: 'Chat',
            description: 'Live chat with the brain over WebSocket. Pick an existing session or start a new one in any project.',
        },
        documents: {
            title: 'Documents',
        ...
        scopes: {
            title: 'Scopes',
            description: 'Manage the tenant, project groups and projects. Edit settings at tenant or project scope.',
        },
        tools: {
            title: 'Server Tools',
            description: 'Configure server-side tools per project. Pick a project or _vance for tenant-wide defaults.',
        },
        insights: {
            title: 'Insights',
            description: 'Inspect sessions, think-processes, chat history, memory and Marvin trees. Read-only diagnostic view.',
        },
        users: {
            title: 'Users & Teams',
            description: 'Manage tenant users (create, password reset, status) and teams (members, enabled flag).',
        },
        open: 'Open',
    },
    chat: {
        ...
        confirmLeave: 'Leave this chat session? The connection will be released and any unsent draft is lost.',
        ...
        speech: {
            ...
            rate: 'Rate',
            volume: 'Volume',
            savedLocally: 'Saved locally. Used by the chat speaker now and any future read-aloud feature.',
        ...
        sessionHeader: {
            ...
            reactivateConfirm: 'Reactivate this archived session? A fresh engine spins up on top of the existing conversation.',
            delete: 'Delete',
            deleteConfirm: 'Permanently delete this session? All messages and metadata will be lost.',
            archived: 'Archived',
        ...
        wizards: {
            ...
            emptyBody: 'Wizards are YAML forms under _vance/wizards/ that turn into structured prompts.',
    ...
    documents: {
        ...
        pickAProjectBody: 'Choose a project from the dropdown above to load its documents.',
        ...
        detail: {
            ...
            titleLabel: 'Title',
            pathLabel: 'Path',
            pathHelp: 'Move or rename this document. Path is unique within the project; conflicts are rejected.',
            mimeTypeLabel: 'MIME type',
            mimeTypeHelp: 'Content type of this document. Fix it here if the original guess was wrong (e.g. Markdown imported as text/plain).',
            summaryEditorLabel: 'Summary',
            summaryEditorHelp: 'Short caption / description. Slideshows show this under each image; the auto-summary scheduler writes here for text documents. For binaries (images, PDFs) the LLM or user writes it manually.',
            summaryEditorSave: 'Save summary',
            summaryEditorSaved: 'Saved.',
            summaryEditorCleared: 'Cleared.',
            ...
            checklistParseError: 'Cannot show checklist view: {message}',
            ...
            summary: {
                ...
                autoSummaryHelp: 'Default is on for text/markdown and text/plain. Switch off to keep the scheduler away from this document.',
                summaryDirtyLabel: 'Mark dirty — re-summarise on next tick',
                summaryDirtyHelp: 'Server flips this off after a successful run. Flip it on manually to force a refresh without editing the body.',
            },
        },
        calendar: {
            viewMonth: 'Month',
        ...
        archives: {
            ...
            confirmRestoreBody: 'The current content is archived as a new version, then this older version becomes the live document. Nothing is lost.',
            confirmDeleteTitle: 'Delete this version permanently?',
            confirmDeleteBody: 'This archived version is removed for good. The live document is not affected.',
        },
        listEditor: {
            addItem: 'Add item',
        ...
        create: {
            ...
            filesLabel: 'Files',
            filesHelp: 'Drop one or more files. The server picks compression per file automatically.',
        ...
        delete: {
            title: 'Move to bin',
            body: 'Move {path} to the bin? You can permanently delete it later from {bin}.',
            cancel: 'Cancel',
            confirm: 'Move to bin',
            titlePermanent: 'Delete permanently',
            bodyPermanent: 'Permanently delete {path}? This removes the document and its stored content. The action cannot be undone.',
            confirmPermanent: 'Delete permanently',
        },
        discard: {
            title: 'Unsaved changes',
            body: 'There are changes to this document that have not been saved yet. What would you like to do?',
            save: 'Save and leave',
            discard: 'Discard',
            cancel: 'Stay here',
        },
    ...
    insights: {
        ...
        process: {
            ...
            prakRunsEmptyBody: 'This process has no PrakRunRecord rows yet. Enable vance.prak.sideChannelEnabled and trigger a compaction.',
        ...
        workflows: {
            ...
            emptyBody: 'This project has no workflow YAMLs under _vance/workflows/. Author one with the workflow-author skill, then refresh.',
            ...
            trigger: {
                title: 'Trigger',
                help: 'Starts a fresh workflow run. Fill in the parameters (required ones marked *), then trigger. The run executes asynchronously on the project lane.',
        ...
        events: {
            ...
            emptyBody: 'This project has no event YAMLs under _vance/events/. Author one with the event-author skill, then refresh.',
            ...
            trigger: {
                title: 'Trigger',
                help: 'Fires the event as an admin (JWT-authenticated). The event’s bearer token is not required here. Optional JSON payload is forwarded to the workflow under params.payload.',
        ...
        llmTrace: {
            ...
            emptyBody: 'Either tracing.llm was off when this process ran, or all rows have aged out (90-day TTL).',
            orphan: '(orphan)',
        ...
        cacheStats: {
            ...
            emptyBody: 'Either tracing.llm was off, or the provider does not emit cache tokens (Gemini, OpenAI). Cache tracking is Anthropic-specific today.',
            headlineTitle: 'Cache hit rate',
            headlineSub: 'across {rounds} LLM calls',
            headlineHint: 'Share of input tokens served from the Anthropic prompt cache — higher is better. Spec target: ≥ 70%.',
            ...
            savingsHint: 'Cache-read tokens cost ~10% of the normal input price; the savings estimate ignores the one-off write surcharge on creation tokens.',
            reload: 'Reload',
        },
        timeline: {
    ...
    tools: {
        ...
        detail: {
            ...
            delete: 'Delete',
            save: 'Save',
            tenantNote: 'You are editing the _tenant system project — changes here are tenant-wide defaults. User projects shadow individual tools by re-creating them with the same name.',
            cascadedFromTenant: 'This tool is cascaded from _tenant (tenant-wide default). Saving creates a project-specific override that shadows the tenant default only in this project.',
            cascadedFromBundled: 'This tool is a built-in default (vance-defaults). Saving creates a project-specific override that shadows the default in this project.',
        },
        source: {
            project: 'Project',
            tenant: 'Tenant',
        ...
        rightPanel: {
            ...
            cascadeBody: 'At runtime tools resolve through project → _vance → built-in beans. Disabled documents stop the cascade — that\'s how you hide a system tool inside a single project.',
        },
        errors: {
            ...
            nameRequired: 'Name is required.',
            namePattern: 'Name must be lower-case alphanumerics with optional "_" (snake_case).',
        ...
        confirmDelete: 'Delete server tool "{name}"? Bundled bean tools with the same name will become visible again through the cascade fallback.',
        stubDescription: '{name} — TODO description',
        newModal: {
            title: 'New server tool',
            nameLabel: 'Name',
            nameHelp: "Lower-case alphanumerics + '_'. Snake_case, like the bundled tools (e.g. doc_getting_started).",
            stubInfo: 'A stub will be created in {project}. Fill in description, parameters and labels afterwards.',
            cancel: 'Cancel',
            create: 'Create',
        },
    },
    toolTemplates: {
        ...
        intro: 'Curated tool packs (Jira, IMAP, SMTP, …). Pick one, fill in the inputs, and the kit is applied to your tenant — passwords are stored encrypted.',
        loading: 'Loading…',
    ...
    connectedAccounts: {
        ...
        loading: 'Loading…',
        intro: 'Connect your accounts at external providers (Slack, Google, Atlassian, …). '
        ...
        confirmDisconnect: 'Disconnect {provider}? Stored tokens will be deleted from the server. Tokens at the provider stay until you revoke them there.',
        empty: {
    ...
    oauthProviders: {
        ...
        confirmDelete: 'Delete OAuth provider "{id}"? Users connected to it lose access until reconnected.',
        confirmRemoveSecret: 'Remove the stored client secret? No new connections will work until you set a new one.',
        sidebar: {
        ...
        cards: {
            ...
            yamlHelp: 'The YAML body lands as document oauth/<providerId>.yaml in the _tenant project. '
            ...
            newSecretHelp: 'Type a new value to set or rotate. Leave blank to keep the current one untouched.',
        ...
        newModal: {
            ...
            idLabel: 'Provider id',
            idHelp: "Lower-case alphanumerics, '-' or '_'. Becomes the path stem and the settings-key prefix (e.g. slack, keycloak-acme).",
            idRequired: 'Provider id is required.',
            idPattern: "Provider id must start with a letter/digit and contain only lower-case letters, digits, '-' and '_'.",
            idAlreadyExists: 'Provider "{id}" already exists.',
            stubInfo: 'A stub YAML will be created. Edit it to set the type (oidc / generic-oauth2 / slack / atlassian / google), endpoints and scopes, then set the client secret.',
            cancel: 'Cancel',
            create: 'Create',
    ...
    users: {
        ...
        user: {
            ...
            confirmDelete: 'Delete user "{name}"? Memberships in teams are not auto-cleaned.',
            statusOptions: {
                active: 'ACTIVE',
                disabled: 'DISABLED',
                pending: 'PENDING',
            ...
            settings: {
                ...
                intro: 'Per-user settings live on the synthetic _user_{name} system project. They take precedence over project and tenant settings in the cascade — useful for per-user model preferences, API keys, language defaults.',
        ...
        createUser: {
            ...
            passwordHelp: 'Empty creates a passwordless account that cannot log in until you set one.',
            cancel: 'Cancel',
            create: 'Create',
    ...
    settingForms: {
        ...
        emptyBody: 'Setting Forms are YAML files under _vance/setting_forms/ that configure settings in a structured way.',
    ...
    scopes: {
        ...
        project: {
            ...
            archivedNote: 'This project is archived. It is read-only for runtime claims but its metadata can still be edited.',
            ...
            languagesDescription: 'Per-project language overrides. When unset, resolution falls through to user / tenant defaults.',
            languageNotSet: 'Not set',
            chatLanguageLabel: 'Assistant language (chat)',
            chatLanguageHelp: 'Overrides the user-profile setting. Example: an English code-review project owned by a German-speaking user.',
            contentLanguageLabel: 'Content language (documents, insights, memory)',
            contentLanguageHelp: 'Language the assistant writes content in. No user layer by design — content belongs to the project.',
        },
        kit: {
            cardTitle: 'Kit',
            ...
            dialog: {
                ...
                pruneHelp: 'Also delete files / settings / tools that the previous kit version had but the new one no longer ships.',
                keepPasswords: 'Keep existing passwords',
                keepPasswordsHelp: 'Skip PASSWORD-settings shipped with the kit so existing project credentials are preserved.',
                trackManifest: 'Record in kit manifest',
                trackManifestHelp: 'On (default): files are tracked in _vance/kit-manifest.yaml as part of the kit, so update/export keep working. Off: one-off splat without tracking — useful for tunings (extra tools / settings) that should not be bound to the active kit.',
        ...
        settingFormsPanel: {
            emptyHeadline: 'No forms available',
            emptyBodyProject: 'Forms are YAML files under _vance/setting_forms/ — e.g. "LLM Settings", "Quota Preset", or "Jira Integration". Delivered via kits or tenant defaults.',
            emptyBodyTenant: 'Forms typically apply at the project level. Pick a project on the left to see the forms available for it.',
            backToList: '← Back to list',
        },
        createGroup: {
            title: 'New project group',
    ...
    inbox: {
        ...
        bulkArchive: {
            ...
            body: 'All active items in the current view whose type is ticked below get archived in one go. The output-only types are preselected — decisions / approvals / orderings stay untouched until you tick them.',
            typesLegend: 'Types',
        ...
        delegate: {
            ...
            body: 'Hand this item to another team member. They will see it in their inbox and can answer / archive on your behalf.',
            recipient: 'Recipient',
            note: 'Note (optional)',
            cancel: 'Cancel',
            confirm: 'Delegate',
    ...
    profile: {
        ...
        preferences: {
            title: 'Preferences',
            description: 'Saved on your user-scope. Other clients (foot, mobile) ignore keys with the webui. prefix.',
            language: 'Language',
            ...
            chatLanguageDescription: 'Which language the assistant replies and listens in. Projects can override this.',
            ...
            uiLevel: 'Surface',
            uiLevelDescription: 'Which tiles appear on the home page. Server permissions still apply independently.',
            ...
            openDocsNewTabDescription: 'When enabled, clicking a document link in the chat opens a new browser tab instead of replacing the current page. Cortex keeps its own in-app tab behaviour either way.',
            openDocsNewTabSaved: 'Preference updated.',
        },
        speech: {
            title: 'Speech & Audio',
            description: 'Defaults for read-aloud and speech recognition. Voice depends on the languages your browser provides; the chat composer offers quick volume + rate sliders for the per-session adjust.',
            voice: 'Voice',
            voiceAuto: 'Auto',
            voiceDefaultSuffix: ' — default',
