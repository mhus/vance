 ...
 */
export function isAccessAlive(marginMs = 30_000) {
 ...
 */
export function isRefreshAlive(marginMs = 5_000) {
    const s = getSessionData();
    if (!s || s.refreshExpiresAtTimestamp == null)
        return false;
 ...
 * load.
 */
export function hydrateActiveWebUiSettings() {
    const s = getSessionData();
    if (!s || !s.webUiSettings)
        return;
...
//# sourceMappingURL=webUiSession.js.map