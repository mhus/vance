...
export default {
  ...
  processPanel: {
    ...
    closeReason: {
      ...
      STALE: 'inkonsistent',
      ARCHIVED: 'archiviert',
      USER_DELETE: 'gelöscht',
      ABANDONED: 'aufgegeben',
      AUTO_CLOSE: 'automatisch geschlossen',
    },
  ...
  cortex: {
    confirmDiscardUnsaved: '„{label}“ konnte nicht gespeichert werden ({reason}).\n\nTrotzdem schließen und die Änderungen verwerfen?',
    noAddon: 'Kein Addon angegeben (?addon=<id> erforderlich).',
    occupied: 'Eine andere Verbindung hält diese Session — den Tab schließen und erneut versuchen.',
    sessionNotFound: 'Session {id} nicht gefunden.',
    accessDenied: 'Der Zugriff auf diese Session wurde verweigert.',
    bindUnbound: 'ungebunden',
    bindAuto: 'auto',
    bindAutoWithPath: 'auto · {path}',
    bindPinnedClosed: 'gepinnt (geschlossen)',
    bindOffTooltip: 'Der Chat ist an kein Dokument gebunden. Umschalten über das Chat-Menü.',
    bindAutoTooltip:
      'Auto: Der Chat folgt dem aktuellen Tab ({path}); die Textauswahl wird mitgesendet. '
      + 'Umschalten über das Chat-Menü.',
    bindAutoTooltipEmpty:
      'Auto: Der Chat folgt dem aktuellen Tab. Ein Dokument öffnen, um es zu binden.',
    bindPinnedTooltip: 'Gepinnt: Der Chat ist an {path} gebunden. Umschalten über das Chat-Menü.',
    bindPinnedTooltipClosed:
      'Das gepinnte Dokument ist geschlossen — wieder öffnen oder den Modus über das Chat-Menü wechseln.',
    ...
    overrideNotObject: 'Der Override muss ein JSON-Objekt sein',
    menu: {
      file: 'Datei',
      newFile: 'Neue Datei…',
      ...
      pinToTab: 'An aktuellen Tab binden',
      unbindChat: 'Chat lösen',
      agentEditing: 'Agent bearbeitet…',
      agentEditingTitle: 'Ein Agent-Tool bearbeitet gerade das an den Chat gebundene Dokument',
      noDocumentHeadline: 'Kein Dokument offen',
      noDocumentBody: 'Links im Baum eines auswählen oder eine neue Datei anlegen.',
    },
    compose: {
      loading: 'Lädt…',
      loadingAnswer: 'Lädt Antwort…',
      noAnswer: 'Der Agent hat keine Antwort erzeugt.',
      stopping: 'stoppt…',
    },
    hactar: {
      applyToEditor: 'In den Editor übernehmen',
      thinking: 'Slart denkt…',
      generatedScript: 'Erzeugtes Skript:',
    ...
    validate: {
      cachedDeep: 'Gecachte tiefe Prüfung',
      noIssuesFound: '✓ keine Auffälligkeiten gefunden',
      title: 'Prüfen',
      quickRunning: 'Schnellprüfung läuft…',
      deepRunning: 'Tiefe Prüfung läuft…',
      close: 'Prüf-Panel schließen',
      quick: 'Schnell:',
      noParseErrors: '✓ keine Parse-Fehler',
      deep: 'Tiefe Prüfung:',
      matchesCurrent: '(passt zum aktuellen Stand)',
      contentChanged: '(Inhalt hat sich seitdem geändert)',
      noIssues: '✓ keine Auffälligkeiten',
      noResult: '(noch kein Prüfergebnis)',
    },
    create: {
      cancel: 'Abbrechen',
      create: 'Anlegen',
    ...
    notes: {
      empty: 'Keine Notizen. Neben eine Zeilennummer oder auf den ＋-Knopf klicken.',
      jumpToLine: 'Sprung zu Zeile {line}',
      title: 'Notizen',
      newNote: 'Neue Notiz',
    ...
    properties: {
      ...
      tags: 'Tags',
      tagsPlaceholder: 'mit, Komma',
      mime: 'MIME',
      color: 'Farbe',
      lock: 'Sperre (weicher Editier-Schutz)',
      lockAi: 'KI',
      lockAiTitle: 'LLM-/Tool-Schreibzugriffe blocken',
      lockUser: 'USER',
      lockUserTitle: 'Manuelle Schreibzugriffe blocken',
      lockKit: 'KIT',
      lockKitTitle: 'Gegen Kit-Apply-Updates einfrieren',
      save: 'Eigenschaften speichern',
      path: 'Pfad',
      kind: 'Kind',
      size: 'Größe',
      created: 'Angelegt',
    ...
    shell: {
      ...
      showNotes: 'Notizen einblenden',
      validate: 'Prüfen',
      deepReviewLabel: 'Tiefe Prüfung',
      argsHint: "JSON-Argument-Objekt, Standard `{'{'}{'}'}`",
      runTitle: '{label} — das Dokument ausführen',
      noLogOutput: '(noch keine Log-Ausgabe)',
      appEditToggle: 'App-/Editier-Umschalter',
      appView: 'App-Ansicht',
      app: 'App',
      rawManifest: 'Roher YAML-Manifest-Editor',
      edit: 'Bearbeiten',
      rawSource: 'Roher Quell-Editor',
      cancelRun: 'Laufende Ausführung abbrechen',
      cancelRunLabel: '■ Abbrechen',
      quickValidate: 'Schnellprüfung — Parsen + Header-Check',
      deepReview: 'Tiefe Prüfung — statische LLM-Prüfung (langsam, serverseitig gecacht)',
      generateScript: 'Neues Skript aus einer Freitext-Beschreibung erzeugen (Slart SCRIPT_JS)',
      generate: '✨ Erzeugen',
      updateScript:
        'Dieses Skript ändern — die Änderung beschreiben, Slart schreibt es strukturerhaltend um',
      update: '✨ Ändern',
    ...
    tree: {
      documents: 'Dokumente',
      reveal: 'Aktive Datei im Baum zeigen',
      reload: 'Dokumentbaum neu laden',
      loading: 'lädt',
      loadingText: 'lädt…',
      delete: 'löschen',
      empty: 'leer',
    ...
    translate: {
      menuDocument: 'Übersetzen…',
      menuSelection: 'Auswahl übersetzen…',
      title: '„{name}“ übersetzen',
      titleSelection: 'Auswahl übersetzen',
      languageLabel: 'Zielsprache',
      customLanguage: 'Andere Sprache…',
      customLanguageLabel: 'Sprache',
      customLanguagePlaceholder: 'z. B. brasilianisches Portugiesisch, einfaches Deutsch',
      targetNameLabel: 'Name der neuen Datei',
      targetNameHelp: 'Wird im selben Ordner wie das Original angelegt.',
      sourceInfo: '{chars} Zeichen werden in einem Durchgang übersetzt.',
      submit: 'Übersetzen',
      cancel: 'Abbrechen',
      close: 'Schließen',
      copy: 'In die Zwischenablage',
      copied: 'Kopiert',
      resultLabel: 'Übersetzung',
      failed: 'Übersetzung fehlgeschlagen.',
      emptyResult: 'Das Modell hat nichts geliefert.',
      maybeTruncated: 'Die Übersetzung ist deutlich kürzer als die Quelle — sie ist womöglich unvollständig.',
      tooLong: 'Zu lang für einen Durchgang: {length} Zeichen, Grenze {max}. Übersetze stattdessen eine Auswahl.',
    },
  },
  ...
  chat: {
    ...
    picker: {
      ...
      recipeFilterPlaceholder: 'Recipes filtern…',
      recipeFilterNoMatch: 'Keine Recipes passen zu „{filter}".',
    ...
    skills: {
      tabLabel: 'Skills',
      title: 'Skills',
      categoryOther: 'Weitere',
      activeBadge: 'aktiv',
      oneShotBadge: 'einmalig',
      refresh: 'Liste aktualisieren',
      play: 'In die Eingabe schreiben',
      clear: 'Skill deaktivieren',
      recipeBoundTitle: 'Vom Recipe mitgegeben — bleibt für die Laufzeit des Prozesses aktiv',
      info: 'Details anzeigen',
      macroBadge: 'Makro',
      stickyBadge: 'Dauerhaft',
      lifecycleStickyHint:
        'Aktivierung bleibt bestehen, bis der Skill deaktiviert wird oder die Session endet — der Skill-Body geht in jeden Turn.',
      lifecycleShotHint:
        'Feuert einmal als Makro (Prompt oder Konfiguration) und wird nie als „aktiv“ gelistet — es gibt nichts aufzuräumen.',
      autoTrigger: 'Automatisch aktiv bei:',
      autoTriggerTitle:
        'Dieser Skill aktiviert sich automatisch, wenn eine Nachricht auf diese Begriffe oder Muster passt.',
      argumentsLabel: 'Argumente',
      requiredLabel: 'Pflicht',
      argumentsHint: 'Als Text hinter dem Skill-Namen anhängen: /skill <name> <werte…>',
      toolsLabel: 'Tools',
      manualPathsLabel: 'Mitgebrachte Manuals',
      referenceDocsLabel: 'Referenz-Dokumente',
      inlineLabel: 'sofort im Prompt',
      onDemandLabel: 'bei Bedarf (manual_read)',
      scriptsLabel: 'Scripts',
      activateLabel: 'Bei Aktivierung',
      deactivateLabel: 'Bei Deaktivierung',
  ...
  insights: {
    pageTitle: 'Insights',
    zarniwoop: {
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seine Such-Provider zu sehen.',
      ...
      callsBreakdown: '({ok} ok / {errors} Fehler)',
      colEnabled: 'Aktiv',
      colInstance: 'Instanz',
      ...
      clearCooldownTitle: 'Diesen Cooldown aufheben — der Provider darf sofort wieder gefragt werden',
    ...
    toolHealth: {
      ...
      scopeTenant: 'Tenant',
      search: 'Suche',
      searchPlaceholder: 'Subjekt, Signatur, Notiz…',
      filter: 'Filter',
      cooldownOnly: 'nur aktive Cooldowns',
      reload: 'Neu laden',
      recordCount: '{shown} / {total} Einträge',
      cooldownCount: '{n} aktiver Cooldown | {n} aktive Cooldowns',
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seinen Tool-Zustand zu sehen.',
      loading: 'Lädt Tool-Zustand…',
      emptyHeadline: 'Keine Zustands-Einträge',
      emptyBodyTenant: 'Für diesen Tenant ist nichts als degradiert oder in Cooldown erfasst.',
      emptyBodyProject: 'Für dieses Projekt ist nichts als degradiert oder in Cooldown erfasst.',
      colSubject: 'Subjekt',
      colKind: 'Art',
      colStatus: 'Status',
      colClassification: 'Klassifikation',
      colCooldowns: 'Cooldowns',
      colSince: 'Seit',
      colNote: 'Notiz',
      noMatch: 'Kein Eintrag passt zu den Filtern.',
      recovery: 'Erholung:',
      recoveryIn: '(in {countdown})',
      noCooldowns: 'Keine aktiven Cooldowns — nichts bremst dieses Subjekt gerade.',
      colSignature: 'Signatur',
      colHits: 'Treffer',
      colUser: 'Benutzer',
      colExpires: 'Läuft ab',
      clear: 'Aufheben',
      clearTitle: 'Diesen Cooldown aufheben — das Subjekt darf sofort wieder feuern',
      kind: {
        feed: 'Feed-Quelle',
        search: 'Such-Provider',
        tool: 'Tool',
      },
    },
    projectTools: {
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seine effektiven Tools zu sehen.',
      loading: 'Lädt Tools…',
      emptyHeadline: 'Keine Tools',
      emptyBody: 'Für dieses Projekt lösen keine eingebauten, Tenant- oder Projekt-Tools auf.',
      search: 'Suche',
      searchPlaceholder: 'Name, Beschreibung, Typ, Label…',
      sources: 'Quellen',
      sourceProject: 'Projekt',
      sourceVance: '_vance',
      sourceBuiltin: 'eingebaut',
      filter: 'Filter',
      primaryOnly: 'nur primäre',
      deferredOnly: 'nur zurückgestellte',
      showDisabled: 'deaktivierte zeigen',
      colName: 'Name',
      colSource: 'Quelle',
      colType: 'Typ',
      ...
      colHealth: 'Zustand',
      colLabels: 'Labels',
      noMatch: 'Kein Tool passt zu den Filtern.',
      hint: 'Hinweis: {text}',
      deferred: 'zurückgestellt',
      deferredTitle: 'Aus dem Manifest ausgeblendet, bis tool_description es aktiviert',
      primary: 'primär',
      onDemand: 'auf Abruf',
      activeCooldowns: '{count} aktive Cooldown(s)',
      note: 'Notiz:',
      recovery: 'Erholung:',
      recoveryIn: '(in {countdown})',
      noCooldowns: 'Keine aktiven Cooldowns.',
      colSignature: 'Signatur',
      colClassification: 'Klassifikation',
      colHits: 'Treffer',
      colUser: 'Benutzer',
      ...
      colExpires: 'Läuft ab',
      clear: 'Aufheben',
      clearTitle: 'Diesen Cooldown aufheben — das Tool darf sofort wieder feuern',
      disabledByInner: 'Von einem Dokument der inneren Schicht deaktiviert',
      countdown: {
        expired: 'abgelaufen',
        seconds: '{n}s',
        minutes: '{n}m',
    ...
    recipes: {
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seine effektiven Recipes zu sehen.',
      loading: 'Lädt Recipes…',
      emptyHeadline: 'Keine Recipes verfügbar',
      emptyBody: 'Für dieses Projekt lösen keine gebündelten, Tenant- oder Projekt-Recipes auf.',
      search: 'Suche',
      searchPlaceholder: 'Name, Beschreibung, Engine…',
      sources: 'Quellen',
      sourceProject: 'Projekt',
      sourceVance: '_vance',
      sourceBundled: 'gebündelt',
      filter: 'Filter',
      ...
      colDescription: 'Beschreibung',
      colParams: 'Parameter',
      colAllowedTools: 'Allowed-Tools Δ',
      colSkills: 'Skills',
      colProfiles: 'Profile',
      noMatch: 'Kein Recipe passt zu den Filtern.',
      skillsDefault: '{count} Standard',
      skillsWhitelist: '· Whitelist {count}',
    },
    rag: {
      noProjectHeadline: 'Kein Projekt ausgewählt',
      noProjectBody: 'Im Seitenleisten-Filter ein Projekt wählen, um sein RAG zu verwalten.',
      disabledPre: 'RAG ist für dieses Projekt abgeschaltet —',
      disabledMid: '. Das Formular',
      llmSettings: 'LLM-Einstellungen',
      disabledPost: 'öffnen und',
      disabledOr: 'oder',
      disabledEnd: 'wählen, um Indizierung und Suche zu aktivieren.',
      cardTitle: 'Projekt-RAG — _documents',
      loading: 'Lädt…',
      status: 'Status',
      statusDisabled: 'abgeschaltet',
      statusActive: 'aktiv',
      statusNotCreated: 'nicht angelegt',
      effectiveProvider: 'Effektiver Provider',
      pinnedTitle:
        'Das RAG wurde mit {created} angelegt — der Tenant löst jetzt auf {effective} auf. '
        + 'Zum Migrieren „Neu bauen“ nutzen.',
      pinnedPre: '(RAG festgelegt auf',
      pinnedPost: ')',
      ragId: 'RAG-Id',
      embeddingModel: 'Embedding-Modell',
      chunks: 'Chunks',
      created: 'Angelegt',
      autoCreatePre: 'Das Standard-RAG des Projekts entsteht automatisch, wenn das Projekt das '
        + 'nächste Mal auf RUNNING geht — oder beim Druck auf',
      autoCreateReindex: 'Neu indizieren',
      actions: 'Aktionen',
      actionsHintPre: 'Neu indizieren',
      actionsHintMid: 'stellt jedes aktive Dokument unter',
      actionsHintRebuild: 'Neu bauen',
      actionsHintPost:
        'verwirft das RAG und legt es mit den aktuellen Tenant-Embedding-Einstellungen neu an; '
        + 'nach einem Provider-Wechsel nutzen.',
      actionsHintKeep: 'zum erneuten Einbetten in das bestehende RAG in die Warteschlange — '
        + 'Embedding-Provider und -Modell bleiben.',
      working: 'Arbeitet…',
      reindex: 'Neu indizieren',
      rebuildButton: 'Mit aktuellem Embedding-Modell neu bauen',
      refresh: 'Aktualisieren',
      confirmDropPre: 'Das',
      confirmDropWord: 'verwirft',
      confirmDropMid: 'das aktuelle',
      confirmDropPost:
        'RAG (samt aller Chunks) und legt es mit den aktuellen Embedding-Einstellungen des '
        + 'Tenants neu an. Danach wird jedes aktive Dokument neu indiziert.',
      confirmHint:
        'Nur bestätigen, wenn Embedding-Provider/-Modell gewechselt wurden und das neue Modell '
        + 'rückwirkend gelten soll.',
      confirmYes: 'Ja, neu bauen',
      cancel: 'Abbrechen',
      lastRun: 'Letzter Lauf:',
      lastRunRebuild: 'Neu bauen',
      lastRunReindex: 'Neu indizieren',
      lastRunQueued: '— {count} Dokument(e) eingereiht.',
      searchTitle: 'Suche',
      searchHintPre:
        'Die Anfrage mit dem Embedding-Modell des RAG einbetten und die 20 ähnlichsten Chunks '
        + 'zurückgeben. Nützlich, um zu sehen, was das Modell als',
      searchHintPost: 'für einen Prompt einspielen würde.',
      searchPlaceholder: 'Im RAG suchen…',
      searching: 'Sucht…',
      search: 'Suchen',
      searchUnavailable: 'Die Suche wird verfügbar, sobald das RAG angelegt ist.',
    ...
    usage: {
      ...
      emptyHeadline: 'Noch keine Nutzungsdaten',
      emptyBody:
        'Sobald ein LLM-Aufruf seine Tokens erfasst, füllt sich diese Ansicht. Modelle ohne '
        + 'Pricing-Block zeigen Tokens und Aufrufe, ihre Kosten stehen aber auf n/a — '
        + 'pricing.inputPerMTok / pricing.outputPerMTok im Modell-YAML ergänzen, um Kosten zu sehen.',
      ...
      coveragePartial:
        ...
        + 'Katalog und liefern Tokens, aber keinen Betrag. Diesen Modell-Einträgen einen',
      coveragePartialPost:
        'Block geben (ein wirklich kostenloses lokales Modell deklariert eine explizite Null).',
      coverageAll: 'Deckt alle {calls} Aufrufe in diesem Fenster ab.',
      coverageFailed: '{failed} Versuche sind fehlgeschlagen; sie werden gezählt, aber nicht zum Betrag addiert.',
      detailHorizon:
        'Die Summen reichen weiter zurück als der Drill-down: Detail pro Aufruf gibt es ab {from}, '
        + 'davor nur Tagessummen.',
      topProjects: 'Top-Projekte',
      project: 'Projekt',
      noProjectData: 'Keine Projektdaten in diesem Fenster.',
      topModels: 'Top-Modelle',
      model: 'Modell',
      noModelData: 'Keine Modelldaten in diesem Fenster.',
      byCaller: 'Nach Aufrufer',
      callerHint:
        'Wer ausgibt. Autonome Arbeit erscheint hier auch, wenn niemand einen Chat ansieht. '
        + 'Think-Engines stehen unter ihrem eigenen Namen; der Rest benennt sich selbst —',
      callerHintLight: 'für Single-Shot-Hilfsaufrufe (Discovery, Follow-up, Titelvorschlag),',
      callerHintCompaction: 'für die Memory-Pflege,',
      callerHintImages: 'für Bilder,',
      callerHintEmbeddings: 'für Embeddings.',
      caller: 'Aufrufer',
      noCallerData: 'Keine Aufrufer-Daten in diesem Fenster.',
      byRecipe: 'Nach Recipe',
      recipe: 'Recipe',
    ...
    toolUsage: {
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seinen gemessenen Tool-Bedarf zu sehen.',
      loading: 'Lädt Tool-Nutzung…',
      emptyHeadline: 'Noch keine Tool-Nutzung erfasst',
      emptyBody:
        'Die Zähler füllen sich, während Agenten in diesem Projekt Tools aufrufen. Direkt nach '
        + 'einem Reset sind sie ebenfalls leer.',
      reload: 'Neu laden',
      roleCount: '{n} Rolle | {n} Rollen',
      toolCount: '{n} Tool | {n} Tools',
      callCount: '{n} Aufruf | {n} Aufrufe',
      discoveryCount: '{n} Discovery-Abfrage | {n} Discovery-Abfragen',
      filterPlaceholder: 'Tool oder Familie filtern…',
      explainPre: 'Bedarf = Aufrufe + Discovery-Abfragen, pro Rolle gezählt. Das '
        + 'Tool-Surface-Budget ordnet Tools mit diesen Zahlen',
      explainInside: 'innerhalb',
      explainPost: 'einer Prioritätsklasse, wenn das Tool-Limit eines Endpunkts einen Schnitt '
        + 'erzwingt — es befördert nie über Klassen hinweg. Discovery-Abfragen zählen separat, '
        + 'weil sie den Bedarf vor der Deferral-Hürde messen.',
      noMatch: 'Kein Tool passt zu „{filter}“.',
    ...
    liveTools: {
      ...
      loading: 'Lädt Client-Tools…',
      bound: 'gebunden',
      notBound: 'nicht gebunden',
      editor: 'Editor: {id}',
      noConnection: 'keine aktive Verbindung',
      emptyHeadlineBound: 'Keine Client-Tools',
      emptyHeadlineUnbound: 'Client nicht verbunden',
      emptyBodyBound: 'Der Client ist verbunden, hat aber keine Tools registriert.',
      emptyBodyUnbound:
        'Live-Tools erscheinen, sobald der Client seinen WebSocket öffnet und seine Tool-Liste sendet.',
      colName: 'Name',
      colPrimary: 'Primär',
      colDescription: 'Beschreibung',
      colParams: 'Parameter',
    ...
    megadodo: {
      ...
      running: '{n} laufend',
      operations: '{n} Operation | {n} Operationen',
      pickProject: 'Ein Projekt wählen, um seine Aktivität zu sehen.',
      loading: 'Lädt…',
      emptyFailed: 'Im gehaltenen Zeitfenster ist nichts fehlgeschlagen.',
      emptyAll: 'Noch keine Aktivität erfasst.',
    },
    tabs2: {
      more: 'Mehr ▾',
    ...
    executions: {
      pickProject: 'In der Seitenleiste ein Projekt wählen, um seine Ausführungen zu sehen.',
      search: 'Suche',
      searchPlaceholder: 'Kommando, Id, Eigentümer, Session…',
      filter: 'Filter',
      onlyRunning: 'nur laufende',
      refresh: 'Aktualisieren',
      loading: 'Lädt Ausführungen…',
      emptyHeadline: 'Keine Ausführungen',
      emptyBody:
        'Für dieses Projekt sind noch keine Shell-Jobs erfasst. Einen über exec_run / '
        + 'client_exec_run starten.',
      colId: 'Id',
      colOwner: 'Eigentümer',
      colStatus: 'Status',
      colCommand: 'Kommando',
      colStarted: 'Gestartet',
      colLastOutput: 'Letzte Ausgabe',
      colExit: 'Exit',
      noMatch: 'Keine Ausführung passt zur Suche.',
      fieldId: 'id:',
      fieldSession: 'session:',
      fieldProcess: 'process:',
      fieldRootDir: 'rootDir:',
      fieldEnded: 'beendet:',
      last: 'letzte',
      lines: 'Zeilen',
      refreshTail: 'Tail aktualisieren',
      loadingStream: 'Lädt {stream}…',
      emptyStream: '(leer)',
    },
    addons: {
      refresh: 'Aktualisieren',
      count: '{n} Addon | {n} Addons',
      loaded: '{n} geladen',
      disabled: '{n} deaktiviert',
      broken: '{n} defekt',
      loading: 'Lädt Addons…',
      emptyHeadline: 'Keine Addons',
      emptyBody:
        'Die Addon-Collection ist leer — keine First-Party-Addons gebündelt, keines über '
        + 'vance-anus installiert.',
      colAddon: 'Addon',
      colStatus: 'Status',
      colSource: 'Quelle',
      colVersion: 'Version',
      colNotes: 'Notizen',
      colUnpacked: 'Entpackt',
      colChecksum: 'Prüfsumme',
      footnotePre: 'Nur-Lesen-Ansicht. Änderungen über',
      footnotePost: '.',
      status: {
        disabled: 'deaktiviert',
        disabledTitle: 'enabled=false in db.addons',
        loaded: 'geladen',
        loadedTitle: 'entpackt + Spring-Bean aktiv',
        broken: 'defekt',
        brokenTitle: 'entpackt, aber Spring hat die VanceAddon-Bean nicht registriert',
        builtin: 'eingebaut',
        builtinTitle: 'Addon steckt im Brain-Image (kein separates .vab-Bundle)',
        missing: 'fehlt',
        missingTitle: 'kein Bundle auf der Platte und keine Spring-Bean',
      },
      checksum: {
        verified: 'geprüft',
        verifiedTitle: 'Der Hash der .vab-Datei entspricht der konfigurierten Prüfsumme',
        mismatch: 'abweichend',
        mismatchTitle:
          'Der Hash der .vab-Datei passt NICHT — der Entrypoint hätte dieses Addon ablehnen müssen',
        unverified: 'ungeprüft',
        unverifiedTitle: 'Prüfsumme gesetzt, aber keine .vab-Quelle zum Vergleichen gecacht',
      },
      source: {
        bundled: 'gebündelt',
        builtin: 'eingebaut',
    ...
    cluster: {
      ...
      projectCount: '{n} Projekt (dieser Tenant) | {n} Projekte (dieser Tenant)',
      master: 'Cluster-Master',
      lease: 'Lease {remaining}',
      noMaster: 'kein Master gewählt',
      loading: 'Lädt Cluster…',
      emptyHeadline: 'Keine Pods',
      emptyBody: 'In diesem Cluster ist kein Brain-Pod registriert.',
      colNode: 'Node',
      colStatus: 'Status',
      ...
      colPlacementTitle: 'Womit der placementSelector eines Projekts verglichen wird',
      colProjects: 'Projekte (dieser Tenant)',
      masterBadge: 'Master',
      masterBadgeTitle: 'Hält gerade das Cluster-Master-Lease',
      selfBadge: 'selbst',
      selfBadgeTitle: 'Das ist das Brain, das diese Anfrage bedient',
      cordoned: 'gesperrt',
      cordonedTitle: 'Exklusiv ohne Labels — auf diesen Pod passt gar nichts.',
      exclusive: 'exklusiv',
      exclusiveTitle: 'Ein Projekt ohne Placement-Selector kommt hier nicht infrage.',
      any: 'beliebig',
      anyTitle: 'Keine Labels und nicht exklusiv — nimmt jedes Projekt.',
      loadScore: 'Score {current} / {max}',
      noCap: 'kein Cap veröffentlicht',
      pctOfCap: '{pct}% des Caps',
      loadHint: 'Summe über alle Tenants — die Zahl, mit der die Platzierung tatsächlich vergleicht.',
      age: {
        seconds: 'vor {n}s',
        minutes: 'vor {n}m',
        hours: 'vor {n}h',
  ...
  scheduler: {
    ...
    form: {
      sectionWhat: 'Was passieren soll',
      description: 'Beschreibung',
      descriptionHelp: 'Ein Satz — erscheint in der Scheduler-Liste und im Web-Editor.',
      targetLabel: 'Trigger-Ziel',
      target_recipe: 'Recipe (spawnt einen Process)',
      target_workflow: 'Workflow (Magrathea)',
      target_script: 'Skript (JS)',
      targetName: 'Name',
      recipeHelp: 'z.B. default, analyze, marvin — aufgelöst über die Projekt-Cascade.',
      scriptSource: 'Skript-Quelle',
      scriptPath: 'Skript-Pfad',
      overlap: 'Overlap-Policy',
      overlapHelp: 'Was passiert, wenn der vorherige Lauf noch aktiv ist.',
      overlap_skip: 'Skip — Tick verwerfen',
      overlap_queue: 'Queue — nach dem vorherigen Lauf',
      overlap_cancelPrevious: 'Cancel — vorherigen Lauf stoppen',
      initialMessage: 'Prompt pro Lauf',
      initialMessageHelp: 'Erste User-Nachricht für den gespawnten Process. Leer = Recipe-Default.',
      sectionWhen: 'Wann er feuert',
      mode: 'Zeitplan',
      mode_hourly: 'Stündlich',
      mode_daily: 'Täglich',
      mode_weekly: 'Wöchentlich',
      mode_monthly: 'Monatlich',
      mode_once: 'Einmalig',
      mode_other: 'Andere (Cron-Ausdruck)',
      everyHours: 'Alle N Stunden',
      everyHoursHelp: 'Feuert zur Minute unten, alle N Stunden.',
      minute: 'Minute',
      minuteHelp: 'Feuert zu dieser Minute jeder Stunde.',
      timeOfDay: 'Uhrzeit',
      monthDay: 'Tag des Monats',
      monthDayHelp: 'Monate ohne den Tag (Februar, der 31.) überspringen den Lauf still.',
      onceAt: 'Zeitpunkt',
      onceAtHelp: 'Feuert einmal, danach wandert das Dokument in den Papierkorb.',
      cron: 'Cron-Ausdruck',
      cronHelp: 'Quartz 6-Felder: <Sek> <Min> <Std> <Tag> <Monat> <Wochentag>.',
      timezone: 'Zeitzone',
      timezoneHelp: 'IANA-Zone (z.B. Europe/Berlin). Leer = UTC.',
      enabled: 'Aktiv',
      enabledHelp: 'Pausierte Scheduler bleiben registriert, feuern aber nicht.',
      sectionIdentity: 'Identität',
      runAs: 'Läuft als (runAs)',
      runAsHelp: 'User, dessen Inbox Fehler und Fragen erhält. Leer = der Ersteller des Dokuments.',
      draftHint:
        'Diese Scheduler-Definition liegt nicht unter _vance/scheduler/ — sie ist ein Entwurf und feuert nicht. Zum Aktivieren dorthin verschieben.',
    },
  },
  ...
  kindViews: {
    chart: {
      parseError: 'Diagramm konnte nicht geparst werden: {message}',
      overrideHint: 'JSON, das über die erzeugte ECharts-Option gemergt wird. Sparsam nutzen.',
      dataHintPre: 'Datenpunkte im Tab',
      dataHintPost: 'bearbeiten.',
      title: 'Titel',
      chart: 'Diagramm',
      subtitle: 'Untertitel',
      legend: 'Legende',
      ...
      type: 'Typ',
      series: 'Serien',
      echartsOverride: 'ECharts-Override',
      raw: 'Roh',
    },
    diagram: {
      downloadSvg: '↓ SVG',
    ...
    docx: {
      refreshTitle: 'Vorschau aktualisieren — zeigt Änderungen nach einem Office-Edit-Save.',
      warnings: '{count} Konvertierungs-Hinweis(e) — das Layout kann von Word abweichen.',
      loading: 'Lädt DOCX…',
      failed: 'DOCX konnte nicht gelesen werden:',
      refresh: '🔄 Aktualisieren',
    },
    formula: {
      empty: 'Leere Formel.',
    ...
    office: {
      ...
      notConfiguredHint: 'Ein Administrator kann unter {path} die Anbindung zu einer self-hosted Document-Server-Instanz einrichten.',
      notConfiguredPath: 'Einstellungen → Integrations → Office-Editor (ONLYOFFICE / Collabora)',
      notConfigured: 'Der Office-Editor ist für dieses Projekt nicht konfiguriert.',
    ...
    xlsx: {
      loading: 'Lädt XLSX…',
      failed: 'XLSX konnte nicht gelesen werden:',
      refreshTitle: 'Vorschau aktualisieren — zeigt Änderungen nach einem Office-Edit-Save.',
      refresh: '🔄 Aktualisieren',
    },
    youtube: {
      videoLabel: 'YouTube-Video',
      noId: 'Aus dem Body ließ sich keine gültige YouTube-Video-ID lesen.',
    },
  },
  shell: {
    expandSidebar: 'Seitenleiste ausklappen',
    expandRightPanel: 'Rechtes Panel ausklappen',
    sessions: 'Sessions',
    loading: 'Lädt…',
  },
  linkCard: {
  ...
  formView: {
    designHint: 'Design-Modus — Formular-Felder (im Block gespeichert). Daten:',
    applyFields: 'Felder übernehmen',
    addRecord: '+ Datensatz hinzufügen',
    cancel: 'Abbrechen',
    saving: 'Speichert…',
    save: 'Speichern',
    loading: 'Lädt Formular…',
    ...
    moveDown: 'Nach unten',
    remove: 'Entfernen',
    choicesHint: 'Eine Auswahl pro Zeile — value oder value|Label',
    addField: '+ Feld hinzufügen',
    applied: 'Übernommen ✓',
    removeRecord: 'Datensatz entfernen',
    saved: 'Gespeichert ✓',
    unsaved: 'Ungespeicherte Änderungen',
    singleRecord: 'Einzelner Datensatz (ein Formular statt Karten-Liste)',
    scriptSession: 'Session für das Skript (nur für LLM- / session-gebundene Tools)',
  },
  chatPanel: {
    connecting: 'Verbindet…',
    elsewhere: 'Diese Session ist in einem anderen Fenster oder auf einem anderen Gerät offen — hier ist sie nicht verbunden.',
    session: 'Session',
  ...
  panic: {
    pressAnyKey: 'eine Taste drücken',
  },
  templateResult: {
    applied: 'Vorlage {name} angewendet.',
  },
  inlineKind: {
    noProject: 'Kein aktuelles Projekt — erst eine Chat-Session binden.',
    saved: 'Gespeichert: {path} — Link kopiert',
    saveFailed: 'Speichern fehlgeschlagen: {message}',
    pathPrompt: 'Pfad für das neue Dokument:',
  },
  compose: {
    runCompose: '▶ Compose ausführen',
    stop: '■ Stoppen',
    clearOutput: 'Ausgabe löschen',
    workspaceLine: 'Workspace: {workspace} · {outcome}',
    success: 'erfolgreich',
    failed: 'fehlgeschlagen',
    progress: 'Läuft… Task {index}',
    progressWithType: 'Läuft… Task {index} ({type})',
    runGone: 'Lauf nicht mehr verfügbar (Pod-Neustart?) — bitte neu ausführen.',
  },
  templateInput: {
    settingHelp: 'Wird verschlüsselt in den Settings gespeichert.',
  },
  blockEditor: {
    slash: {
      paragraph: { title: 'Text', hint: 'Einfacher Absatz' },
      'heading-1': { title: 'Überschrift 1', hint: 'Große Abschnitts-Überschrift' },
      'heading-2': { title: 'Überschrift 2', hint: 'Mittlere Überschrift' },
      'heading-3': { title: 'Überschrift 3', hint: 'Kleine Überschrift' },
      bullet: { title: 'Aufzählung', hint: '- Eintrag' },
      numbered: { title: 'Nummerierte Liste', hint: '1. Eintrag' },
      todo: { title: 'Aufgabe', hint: '- [ ] Aufgabe' },
      quote: { title: 'Zitat', hint: 'Abgesetztes Zitat' },
      code: { title: 'Code-Block', hint: 'Fenced Code' },
      divider: { title: 'Trennlinie', hint: '---' },
      toggle: { title: 'Ausklappbar', hint: 'Zusammenklappbarer Abschnitt' },
      'link-card': { title: 'Link-Karte', hint: 'URL-Vorschau mit Bild' },
      dataview: { title: 'Dataview', hint: 'Aggregation einbetten (Stub)' },
      image: { title: 'Bild', hint: 'Aus den Assets wählen oder hochladen' },
      toc: { title: 'Inhaltsverzeichnis', hint: 'Automatisch aus den Überschriften' },
      embed: { title: 'Dokument einbetten', hint: 'Ein anderes Vance-Dokument inline — Kind-bewusste Karte' },
      form: { title: 'Formular', hint: 'Editierbares Eingabeformular (an eine Edit-Config gebunden)' },
      input: { title: 'Eingabe', hint: 'Editierbarer Text, an eine Datei gebunden (ein- oder mehrzeilig)' },
      button: { title: 'Knopf', hint: 'Klickbarer Knopf, der ein Skript ausführt' },
      field: { title: 'Formularfeld', hint: 'Frage mit Inline-Antwort (Einfachauswahl, Mehrfachwahl, Text…)' },
      compose: { title: 'Compose', hint: 'Einen Damogran-Compose-Task inline ausführen' },
      columns2: { title: '2 Spalten', hint: 'Layout nebeneinander' },
      columns3: { title: '3 Spalten', hint: 'Drei-Spalten-Layout' },
      callout: { title: 'Hinweis', hint: 'Info / Warnung / Notiz' },
      composeJs: { title: 'Compose JS', hint: 'Compose-Block mit einem JS-Task' },
      composeBash: { title: 'Compose Bash', hint: 'Compose-Block mit einem Shell-Task' },
      composePython: { title: 'Compose Python', hint: 'Compose-Block mit einem Python-Task' },
      composeR: { title: 'Compose R', hint: 'Compose-Block mit einem R-Task (Rserve, WORK-only)' },
      composeAgent: { title: 'Compose Agent', hint: 'Compose-Block mit einem Agent-Task' },
      menuTitle: 'Block einfügen',
      noMatch: 'Kein passender Block',
    },
    callout: {
    ...
    compose: {
      agentPlaceholder: 'Analysiere die Dateien im Workspace und fasse zusammen.',
      settingsYaml: 'Einstellungen (YAML)',
      run: 'Ausführen',
      runCompose: 'Compose ausführen',
      stop: 'Stoppen',
      running: 'Läuft…',
      moreActions: 'Weitere Aktionen',
      runAllUntil: 'Alle bis hier ausführen',
      clearOutput: 'Ausgabe löschen',
      clearAllOutput: 'Alle Ausgaben löschen',
      stopping: 'stoppt…',
      runGone: 'Lauf nicht mehr verfügbar (Pod-Neustart?) — bitte neu ausführen.',
      runFailed: 'Compose-Lauf fehlgeschlagen',
    },
    blocks: {
      dataview: 'Dataview',
      dataviewHint: 'Dataview-Rendering ist noch nicht implementiert.',
      toc: 'Inhaltsverzeichnis',
      tocEmpty: 'Noch keine Überschriften auf dieser Seite.',
      compose: '⚙ Compose',
      embed: '🔗 Embed',
      form: '📝 Formular',
      input: '✏ Eingabe',
      button: 'Knopf',
      field: 'Formularfeld',
      runnableHint: 'Im Editor ausführbar.',
      editableHint: 'Im Editor editierbar.',
    ...
    trash: {
      over: 'Loslassen zum Löschen',
      idle: 'Hierher ziehen, um zu löschen',
    },
    input: {
      saveScript: 'saveScript',
      saveScriptPlaceholder: 'z.B. update.js (relativ zum Ordner, optional)',
      sessionForScript: 'Session für das Skript (nur für LLM- / session-gebundene Tools)',
      saved: 'Gespeichert ✓',
      cancel: 'Abbrechen',
    },
    button: {
    ...
    field: {
      typeText: 'Text (einzeilig)',
      typeTextarea: 'Text (mehrzeilig)',
      typeChoice: 'Einfachauswahl',
      typeMulti: 'Mehrfachauswahl',
      typeDropdown: 'Dropdown',
      idPlaceholder: 'Feld-ID (z.B. q1)',
