...
export default {
  ...
  documents: {
    ...
    detail: {
      ...
      summaryEditorHelp:
        'Short caption / description. Slideshows show this under each image; the auto-summary scheduler writes here for text documents. For binaries (images, PDFs) the LLM or user writes it manually.',
    ...
    revertConfirm: {
      ...
      body:
        'The document will be reloaded from the server. Any unsaved changes will be lost.',
      cancel: 'Cancel',
