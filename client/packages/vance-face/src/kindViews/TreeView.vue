...
.tree-edit-nested {
  ...
  padding-left: 1.5rem;
  border-left: 1px dashed color-mix(in oklab, var(--color-base-content) 15%, transparent);
}
.tree-rows {
  list-style: none;
  padding: 0;
...
.row-action:hover { opacity: 1; background: color-mix(in oklab, var(--color-base-content) 6%, transparent); }
.row-delete:hover {
