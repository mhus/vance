    ...
    const virtual_mfExposes___mfe_internal__vance_addon_calendar__remoteEntry_js = {
        ...
        "./CalendarPlanner": async () => {
          ...
          const importModule = await importExposedModule(
            () => __vitePreload(() => import('./CalendarPlanner-BYNgVO1t.js'),true?[]:void 0)
          );
          const exportModule = {};
      ...
      ,
        "./CalendarView": async () => {
          ...
          const importModule = await importExposedModule(
            () => __vitePreload(() => import('./CalendarView-D9xoSkYX.js'),true?[]:void 0)
          );
          const exportModule = {};
          Object.assign(exportModule, importModule);
          Object.defineProperty(exportModule, "__esModule", {
      ...
      ,
        "./register": async () => {
          ...
          const importModule = await importExposedModule(
            () => __vitePreload(() => import('./register-Cd9YUOsn.js'),true?[]:void 0)
          );
          const exportModule = {};
          Object.assign(exportModule, importModule);
          Object.defineProperty(exportModule, "__esModule", {
