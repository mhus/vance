const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CodeEditor-k8onLjY-.css","./CalendarView-UChuAuu4.css"])))=>i.map(i=>d[i]);
    ...
    const virtual_mfExposes___mfe_internal__vance_addon_calendar__remoteEntry_js = {
        ...
        "./CalendarPlanner": async () => {
          ...
          const importModule = await importExposedModule(
            () => __vitePreload(() => import('./CalendarPlanner-DGrHtv9X.js'),true?__vite__mapDeps([0]):void 0,import.meta.url)
          );
          const exportModule = {};
