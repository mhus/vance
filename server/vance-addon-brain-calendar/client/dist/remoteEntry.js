...
const __mfResolveGlobalKey = "__mf_init__virtual:mf:__mfe_internal__vance_addon_calendar__mf_v__runtimeInit__mf_v__.js__";
...
const __mfModuleCache = globalThis[__mfCacheGlobalKey];
  ...
  const mfName = "__mfe_internal__vance_addon_calendar";
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-CmeAa2aY.js'),true?[]:void 0,import.meta.url))
