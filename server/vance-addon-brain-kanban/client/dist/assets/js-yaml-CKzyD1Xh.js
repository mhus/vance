...
const setFollowUp = StateEffect.define();
const followUpField = StateField.define({
  create: () => null,
  update(value, tr) {
...
function buildTooltip(state, acceptHint) {
...
function followUpExtension(opts) {
  ...
  return [
    ...
    showTooltip.compute(
      [followUpField],
      (state) => buildTooltip(state.field(followUpField), acceptHint)
    ),
    Prec.high(
      keymap.of([
...
export { Annotation as A, ChangeSet as C, Decoration as D, EditorState as E, Facet as F, GutterMarker as G, MapMode as M, Prec as P, RangeSetBuilder as R, StateField as S, Transaction as T, ViewPlugin as V, WidgetType as W, EditorView as a, StateEffect as b, combineConfig as c, countColumn as d, StyleModule as e, RangeSet as f, gutter as g, Direction as h, EditorSelection as i, ChangeDesc as j, Text as k, logException as l, findClusterBreak as m, keymap as n, RangeValue as o, lineNumbers as p, highlightActiveLine as q, Compartment as r, followUpExtension as s };
