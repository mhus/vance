...
const __mfResolveGlobalKey = "__mf_init__virtual:mf:__mfe_internal__vance_addon_slideshow__mf_v__runtimeInit__mf_v__.js__";
...
const __mfModuleCache = globalThis[__mfCacheGlobalKey];
  ...
  const mfName = "__mfe_internal__vance_addon_slideshow";
  ...
  async function getLocalSharedImportMap() {
    if (!localSharedImportMapPromise) {
      localSharedImportMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/_virtual_mf-localSharedImportMap___mfe_internal__vance_addon_slideshow-6mcRxIny.js'),true?[]:void 0,import.meta.url))
  ...
  async function getExposesMap() {
    if (!exposesMapPromise) {
      exposesMapPromise = retrySharedInit(() => __vitePreload(() => import('./assets/virtualExposes-qdRR0bzh.js'),true?[]:void 0,import.meta.url))
  ...
  async function init(shared = {}, initScope = []) {
    ...
    if (__mfModuleCache.share["vue"] === undefined) {
        const mod = await __vitePreload(() => import('./assets/_virtual_mf___mfe_internal__vance_addon_slideshow__loadShare__vue__loadShare__.mjs-CtZISMkN.js').then(n => n._),true?[]:void 0,import.meta.url);
