 ...
 * about:
 *
 *   1. **App**   — images uploaded into this workbook's `assets/`
 ...
 *   3. **Shared** — flat list under `workbook/images/` in the
...
const props = defineProps<{
  projectId: string;
  /** Workbook folder root — assets live under `<folder>/assets/`. */
...
// --- Tab 1: App ---------------------------------------------------
const assetsFolder = computed(() => `${props.workbookFolder}/assets/`);
