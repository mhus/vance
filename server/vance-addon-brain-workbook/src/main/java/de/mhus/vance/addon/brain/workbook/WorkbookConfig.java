...
/**
 * Typed view on the {@code workbook:} block of an {@code _app.yaml}
...
public record WorkbookConfig(
    ...
    public static final String APP_NAME = "workbook";
    ...
    public static WorkbookConfig parse(String manifestBody) {
        ...
        if (!(wsRaw instanceof Map<?, ?> ws)) {
            // No `workbook:` block — still expose top-level title /
    ...
    public static WorkbookConfig defaults() {
        return new WorkbookConfig(
                null,
                null,
                null,
