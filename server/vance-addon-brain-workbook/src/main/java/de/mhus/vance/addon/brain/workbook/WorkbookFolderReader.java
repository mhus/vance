...
/**
 * Scans a workbook folder for {@code kind: workpage} pages plus the
 ...
 */
@Component
public class WorkbookFolderReader {

    public static final String APP_MANIFEST = "_app.yaml";

    private final DocumentService documentService;

    public WorkbookFolderReader(DocumentService documentService) {
    ...
    public Scan scan(String tenantId, String projectId, String folder) {
        ...
        List<WorkbookPage> pages = new ArrayList<>();
    ...
    private WorkbookConfig parseConfig(DocumentDocument manifest) {
