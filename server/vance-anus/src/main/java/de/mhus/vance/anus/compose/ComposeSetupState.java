...
class ComposeSetupState {
    ...
    // ── feature toggles ───────────────────────────────────────────
    /**
     * Fook bug/feature triage. Default on — triage is local (tickets land in
     * the tenant's own {@code _vance} project) and upstream forwarding is a
     * separate admin consent ({@code fook.upstream.mode} defaults to
     * {@code never}), so enabling this alone sends nothing out.
     */
