...
public class ToolHealthSetCooldownTool implements Tool {
    ...
    private static final Map<String, Object> SCHEMA = Map.of(
                    ...
                    Map.of(
                            ...
                            "errorSignature",
                                    Map.of(
                                            ...
                                            "string",
                                            "description",
                                            "Signature string identifying the specific failure class this record targets."),
                            "userId",
                                    Map.of(
                                            "type",
                                            "string",
            ...
            "required", List.of("scope", "toolName", "errorSignature", "duration", "classification"));
    ...
    public Map<String, Object> invoke(Map<String, Object> params, ToolInvocationContext ctx) {
        ...
        try {
            ...
            throw new ToolException("Invalid duration: " + e.getMessage(), e);
        }
        ToolHealthClassification classification;
        try {
            classification = ToolHealthClassification.valueOf(
                    ToolHealthReadTool.stringParam(params, "classification").toUpperCase(Locale.ROOT));
        } catch (IllegalArgumentException e) {
            throw new ToolException("Invalid classification", e);
        }

        ToolHealthCooldown cd = toolHealthService.setCooldown(
                ctx.tenantId(),
                scope,
                scopeId == null ? ToolHealthSetUnavailableTool.defaultScopeId(scope, ctx) : scopeId,
                toolName,
                signature,
                userId,
                classification,
