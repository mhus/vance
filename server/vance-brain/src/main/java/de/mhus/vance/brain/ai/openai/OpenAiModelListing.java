 ...
 * </ul>
 *
 * <p>Only observations are extracted. {@code kind}, pricing and capabilities
 * stay absent — see {@link DiscoveredModelInfo}'s class doc for why the auto
 * layer must not assert classifications.
 *
...
public final class OpenAiModelListing {
    ...
    private static final List<String> CONTEXT_KEYS = List.of(
            "context_window", "context_length", "max_context_length", "max_input", "max_input_tokens", "max_tokens");
