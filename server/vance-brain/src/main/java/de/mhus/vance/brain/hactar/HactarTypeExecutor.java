...
/**
 * Per-{@link HactarTaskType} executor. One Spring bean per task type;
 * {@link HactarTaskExecutor} indexes them by {@link #type()} and
 ...
 */
public interface HactarTypeExecutor {
     ...
     */
    Optional<TaskOutcome> execute(HactarTaskContext context);
}
