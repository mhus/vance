...
@Slf4j
public class ShellTaskExecutor implements HactarTypeExecutor {
    ...
    public HactarTaskType type() {
        return HactarTaskType.SHELL_TASK;
    }
    ...
    public Optional<TaskOutcome> execute(HactarTaskContext context) {
        ...
        try {
            ...
            log.warn("Hactar shell_task '{}' failed to submit: {}", state.name(), ex.getMessage());
