...
public class HelpController {
    ...
    private static final Pattern PATH_PATTERN = Pattern.compile("^[A-Za-z0-9._-]+(/[A-Za-z0-9._-]+)*$");
    ...
    public ResponseEntity<byte[]> get(
            @PathVariable("lang") String lang, @PathVariable("resourcePath") String resourcePath) {
        ...
        if (normalised.isBlank()
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Invalid resource path");
        }
        ...
        if (!resource.exists()) {
            ...
            if (!resource.exists()) {
                throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Help resource not found: " + normalised);
            }
        }
        ...
        try (var in = resource.getInputStream()) {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to read help resource", e);
        }
    }
