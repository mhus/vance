...
public class InboxArchiveHandler implements WsHandler {
    ...
    @Override
    public String type() {
        return MessageType.INBOX_ARCHIVE;
    }
    ...
    public void handle(ConnectionContext ctx, WebSocketSession wsSession, WebSocketEnvelope envelope)
        ...
        try {
            ...
            sender.sendError(wsSession, envelope, 400,
                    "Invalid inbox-archive payload: " + e.getMessage());
            return;
        }
        ...
        sender.sendReply(wsSession, envelope, MessageType.INBOX_ARCHIVE,
