...
public class KitStoreCredentials {
    ...
    public KitAccess resolve(
        ...
        if (url == null || url.isBlank()) {
            return new KitAccess(tenantId, projectId, explicitToken, null, java.util.Map.of(), null);
        }
        KitSourceDto source;
        try {
        ...
        return new KitAccess(tenantId, projectId, token, account, java.util.Map.of(), null);
    }
}
