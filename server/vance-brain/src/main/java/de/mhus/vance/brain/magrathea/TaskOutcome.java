...
/**
 * What a {@link MagratheaTypeExecutor} returns to the
 * {@link MagratheaTaskExecutor} when it finishes synchronously. The
 ...
 * from {@link MagratheaTypeExecutor#execute} instead — completion arrives
