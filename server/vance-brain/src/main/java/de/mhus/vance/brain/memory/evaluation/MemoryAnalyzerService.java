...
import de.mhus.vance.shared.memory.evaluation.AffectsAction;
...
import de.mhus.vance.shared.memory.evaluation.ScopeKind;
import de.mhus.vance.shared.memory.evaluation.TargetRef;
import de.mhus.vance.shared.memory.evaluation.TargetRefKind;
 ...
 * {@link MemoryEvaluationSanitizer} themselves so each trigger
...
public class MemoryAnalyzerService {
     ...
     */
    public static final String DEFAULT_RECIPE_NAME = "_memory-evaluation-analyzer";
        ...
        if (itemsRaw instanceof List<?> list) {
            for (Object o : list) {
                if (!(o instanceof Map<?, ?> m)) {
                    log.debug("MemoryAnalyzer: dropping non-object item entry: {}", o);
                    continue;
                }
