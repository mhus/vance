 ...
 * configuration via {@link MemoryEvaluationProperties}. The intent is
...
@Slf4j
public class MemoryEvaluationSanitizer {

    private final MemoryEvaluationProperties props;
    ...
    private int computeHardCap(de.mhus.vance.shared.memory.evaluation.ItemCountExpectation expected) {
