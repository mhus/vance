...
/** Markdown document → ODT via the existing {@link OdtReportRenderer}. */
@Component
@RequiredArgsConstructor
public class MarkdownToOdtTransformer implements DocumentTransformer {

    private final DocumentService documentService;
    private final OdtReportRenderer renderer;
