...
/**
 * Shared helper for Vance hub-tools that operate on "the current
 * project". Vance maintains an active project as a scratchpad slot
 ...
 * Vance shouldn't accidentally write user-document operations into
 * her own hub project unless explicitly asked.
 */
@Component
@RequiredArgsConstructor
public class VanceContext {

    /**
     * Scratchpad slot under the Vance hub-process holding the current
     * active project name (matches {@code ProjectDocument.name}).
     */
    public static final String ACTIVE_PROJECT_SLOT = "vance.activeProject";

    private final ScratchpadService scratchpad;
    private final ProjectService projectService;

    /**
     * Reads the active-project slot for the calling Vance process.
