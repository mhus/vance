...
/**
 * Append-and-recap façade over {@link VanceActivityRepository}. The
...
@Slf4j
public class VanceActivityService {
    ...
    private final VanceActivityRepository repository;
     ...
     */
    public VanceActivityEntry append(
            String tenantId,
            String userId,
            String sessionId,
            String vanceProcessId,
            VanceActivityKind kind,
            String summary,
            List<EntityRef> refs) {
        VanceActivityEntry entry = VanceActivityEntry.builder()
                .tenantId(tenantId)
                .userId(userId)
                .sessionId(sessionId)
                ...
                .build();
        VanceActivityEntry saved = repository.save(entry);
     ...
     */
    public List<VanceActivityEntry> readPeerRecap(
