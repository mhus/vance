...
class DocumentSummarySchedulerTest {
    ...
    void setUp() {
        ...
        when(clusterService.selfPodId()).thenReturn(NODE);
    }

    @Test
    void tick_noProjects_doesNothing() {
        when(projectService.findRunningByHomePodId(NODE)).thenReturn(List.of());
    ...
    void tick_settingDisabled_skipsProject() {
        ...
        when(projectService.findRunningByHomePodId(NODE)).thenReturn(List.of(project));
    ...
    void tick_claimQueryFails_movesOnToNextProject() {
        ...
        when(projectService.findRunningByHomePodId(NODE)).thenReturn(List.of(p1, p2));
        when(settingService.getBooleanValueCascade(
