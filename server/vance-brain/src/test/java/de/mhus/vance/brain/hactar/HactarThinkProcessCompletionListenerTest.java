...
class HactarThinkProcessCompletionListenerTest {
    ...
    private final HactarThinkProcessCompletionListener listener =
            new HactarThinkProcessCompletionListener(
    ...
    void missing_process_document_yields_technical_error() {
        HactarTaskDocument task = task("p-vanished", "ford");
    ...
    private void wireTask(String processId, String engineName, CloseReason closeReason) {
        HactarTaskDocument task = task(processId, engineName);
    ...
    private static HactarTaskDocument task(String subProcessId, String engineName) {
