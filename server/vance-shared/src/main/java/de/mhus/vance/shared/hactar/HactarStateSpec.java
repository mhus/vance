 ...
 * @param retry Retry spec, {@link HactarRetrySpec#none()} when omitted.
...
public record HactarStateSpec(
        ...
        Map<HactarErrorKind, String> catchKinds,
        List<HactarTransition> transitions,
        HactarRetrySpec retry,
