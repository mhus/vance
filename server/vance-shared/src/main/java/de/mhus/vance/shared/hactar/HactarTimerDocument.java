...
/**
 * Pending timer in {@code hactar_timers}. Pod-local
 * {@code HactarTimerScanner} (in {@code vance-brain}) scans for
 ...
 * </ul>
 */
@Document(collection = "hactar_timers")
@CompoundIndexes({
        @CompoundIndex(
                name = "fire_idx",
...
@NoArgsConstructor
@AllArgsConstructor
public class HactarTimerDocument {
    ...
    /** The {@code hactar_tasks} row this timer fires a completion for. */
