 ...
 */
public record ResolvedMagratheaWorkflow(
        String name,
        String yaml,
        MagratheaWorkflowSource source,
        @Nullable String documentId,
        @Nullable String createdBy,
        @Nullable String description,
        @Nullable String version,
        String startState,
        Map<String, MagratheaParameterSpec> parameters,
        Map<String, MagratheaStateSpec> states,
        MagratheaBoundsSpec bounds,
