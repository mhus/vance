...
/**
 * Think processes running inside the account's own sessions.
 *
...
public class ThinkProcessSessionUserDataHandler implements UserDataHandler {
    ...
    @Override
    public String id() {
        return "think-processes-of-sessions";
    }

    @Override
    public Set<String> collections() {
        return Set.of(mongoTemplate.getCollectionName(ThinkProcessDocument.class));
    }
    ...
    public long count(String tenantId, String userName) {
        ...
        return query == null ? 0 : mongoTemplate.count(query, ThinkProcessDocument.class);
    }
    ...
    public long delete(String tenantId, String userName) {
        ...
        return query == null
                ? 0
                : mongoTemplate.remove(query, ThinkProcessDocument.class).getDeletedCount();
    }
